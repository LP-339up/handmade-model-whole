...
//			$(this).html("<img src='mages/loading.gif' class='loading' />");
		});
		$.ajax({
			error:function(){
...
//			$(this).html("<img src='images/loading.gif' class='loading' />");
		...
		case "iframe":
		$("#windown-content").ajaxStart(function(){
//			$(this).html("<img src='images/loading.gif' class='loading' /><p><div style=\"color:#999999; margin-top:160px; font-size:12px; font-family:Arial, Helvetica, sans-serif\">Please Waiting, Loading...</div></p>");
		});
		$.ajax({
			error:function(){
				$("#windown-content").html("<p class='windown-error'>加载数据出错...</p>");
