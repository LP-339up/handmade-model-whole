...
var getCart=function(req,res){
    ...
    //当用户传入用户名的时候，从数据库中查询商品信息
    var sql=`SELECT g.id id,g.name NAME, g.price price, g.goodsImg goodsImg,g.attr attr,g.limitation limitation,s.quantity quantity, s.account account 
...
//删除购物车
var deletaCart=function(req,res){
...
//修改购物车
var EditCart=function(req,res){
    var body=req.body
    //操作数据库
    var data=[body.quantity,body.account,body.id]
