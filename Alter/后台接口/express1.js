...
//最热卖商品列表
app.get('/getHeatgoods',router.getHeatgoods).post('/getHeatgoods',router.getHeatgoods)
...
//获取状态订单
app.get('/getOrder_management1',router.getOrder_management1).post('/getOrder_management1',router.getOrder_management1)

//删除订单
app.get('/deletaOrder_management',router.deletaOrder_management).post('/deletaOrder_management',router.deletaOrder_management)

//修改订单
app.get('/EditOrder_management',router.EditOrder_management).post('/EditOrder_management',router.EditOrder_management)

// 登陆接口
app.get('/login',router.login).post('/login',router.login)

// 注册接口
app.get('/register',router.register).post('/register',router.register)

//修改个人信息接口
app.get('/personal',router.personal).post('/personal',router.personal)

// 修改密码接口
app.get('/password',router.password).post('/password',router.password)

// 修改送货地址接口
app.get('/delivery',router.delivery).post('/delivery',router.delivery)

// 获取送货地址接口
app.get('/getdelivery',router.getdelivery).post('/getdelivery',router.getdelivery)

// 删除送货地址接口
app.get('/deletadelivery',router.deletadelivery).post('/deletadelivery',router.deletadelivery)
